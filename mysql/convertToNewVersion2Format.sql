...
-- -- Failed attempts, always getting tangled up in FK constraints:
-- CREATE TABLE pfand_copy (
--     pfand_id INTEGER(10) UNSIGNED NOT NULL AUTO_INCREMENT,
--     artikel_id INTEGER(10) UNSIGNED NOT NULL,
--     PRIMARY KEY (pfand_id)
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- CREATE TABLE produktgruppe_copy (
...
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
-- INSERT INTO pfand_copy SELECT * FROM pfand;
-- INSERT INTO produktgruppe_copy SELECT produktgruppen_id, toplevel_id, sub_id, subsub_id, produktgruppen_name,
--    mwst_id, pfand_id, std_einheit, n_artikel, n_artikel_rekursiv, aktiv FROM produktgruppe;
-- INSERT INTO artikel_copy SELECT artikel_id, produktgruppen_id, lieferant_id, artikel_nr, artikel_name, kurzname, menge,
--   einheit, barcode, herkunft, vpe, setgroesse, vk_preis, empf_vk_preis, ek_rabatt, ek_preis, variabler_preis, sortiment,
--   lieferbar, beliebtheit, bestand, von, bis, aktiv FROM artikel;

-- CREATE TABLE rabattaktion_copy (
...
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
-- INSERT INTO rabattaktion_copy SELECT * FROM rabattaktion;
...
-- CREATE TABLE bestellung_details_copy (
...
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
-- INSERT INTO bestellung_details_copy SELECT * FROM bestellung_details;

-- CREATE TABLE training_verkauf_details_copy (
--     vd_id INTEGER(10) UNSIGNED NOT NULL AUTO_INCREMENT,
--     rechnungs_nr INTEGER(10) UNSIGNED NOT NULL,
--     position SMALLINT(5) UNSIGNED DEFAULT NULL,
--     artikel_id INTEGER(10) UNSIGNED DEFAULT NULL,
...
--     PRIMARY KEY (vd_id)
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
-- INSERT INTO training_verkauf_details_copy SELECT * FROM training_verkauf_details;

-- -- drop the original artikel and FK constraint tables:
-- ALTER TABLE pfand DROP CONSTRAINT pfand_ibfk_1;
-- ALTER TABLE produktgruppe DROP CONSTRAINT produktgruppe_ibfk_2;
-- DROP TABLE artikel, pfand, produktgruppe, rabattaktion, verkauf_details, bestellung_details, training_verkauf_details;
-- DROP TABLE artikel;

-- -- create the real tables to be filled with shifted IDs:
-- CREATE TABLE pfand (
--     pfand_id INTEGER(10) UNSIGNED NOT NULL AUTO_INCREMENT,
--     artikel_id INTEGER(10) UNSIGNED NOT NULL,
--     PRIMARY KEY (pfand_id)
...
-- -- Fill with shifted IDs:
-- LOCK TABLES `pfand` WRITE;
-- /*!40000 ALTER TABLE `pfand` DISABLE KEYS */;
-- INSERT INTO pfand SELECT pfand_id, artikel_id + 1 FROM pfand_copy;
-- /*!40000 ALTER TABLE `pfand` ENABLE KEYS */;
-- UNLOCK TABLES;

-- -- drop the temporary copies:
-- DROP TABLE artikel_copy, pfand_copy, produktgruppe_copy, rabattaktion_copy, verkauf_details_copy, bestellung_details_copy, training_verkauf_details_copy;
