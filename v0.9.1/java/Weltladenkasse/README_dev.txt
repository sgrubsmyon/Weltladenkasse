...
#ant && java -jar Weltladenkasse_v0.9.1.jar
#ant && java -jar Weltladenbesteller_v0.9.1.jar
ant && ./make_release.sh

Create JAR file:
jar cfe Weltladenkasse_v0.9.1.jar Weltladenkasse.Kasse icons/ jcalendarbutton/ Weltladenkasse/
